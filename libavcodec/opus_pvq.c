                                                     ...
                                                     int fill, int quant)
{
    ...
    if (!stereo && level == 0) {
        ...
        if (lowband &&
            (recombine || ((N_B & 1) == 0 && tf_change < 0) || valueB0 > 1)) {
            for (i = 0; i < N; i++)
    ...
    if (split) {
        ...
        if (N == 2 && stereo) {
             ...
             * otherwise deserve */
            if (valueB0 > 1 && !stereo && (itheta & 0x3fff)) {
                if (itheta > 8192)
